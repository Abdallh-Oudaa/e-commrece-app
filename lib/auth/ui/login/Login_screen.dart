import 'package:e_comrece_app/auth/ui/register/register_screen.dart';
...
import 'login_view_model_cubit.dart';
      ...
      listener: (context, state) {
        if (state is LoginViewModelSuccess) {
          ...
          DialogUtils.showMessage(
            ...
            posAction: "ok",
            posCallBack: () => DialogUtils.hideDialog(context: context),
          );
        } else {
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if(viewModel.formKey.currentState!.validate()==true){  viewModel.login();}
                ...
                InkWell(
                  onTap: (){Navigator.pushReplacementNamed(context, RegisterScreen.routName);},
                  child: Padding(
