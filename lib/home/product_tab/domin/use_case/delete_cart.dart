...
class DeleteCartItemsUseCase{
  ...
  DeleteCartItemsUseCase({required this.getCartRepoContract});
  Future<Either<GeneralErrors, GetCartItemsEntity>?> invoke(String productId){
    return  getCartRepoContract.deleteCart(productId);
  }
}